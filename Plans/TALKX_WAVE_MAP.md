...
> Harita ile Wave 01–19 planları hazırdır. Wave 01–05 Sale Release kapsamları 2026-09-23 tarihinde auto-verified/committed/manual-QA-deferred kapanışına ulaştı; Wave 06–19 başlatılmadı.
...
- **Uygulama durumu:** Wave 01–05 auto-verified; ayrı repo commitleri ve ertelenmiş manuel QA ile kapalı
- **İlk yürütme adayı:** Wave 06 — yalnız ayrı açık kullanıcı talimatıyla
...
- **Sonraki işlem:** Dur; Wave 06 için ayrı açık başlangıç talimatını bekle

Wave 06 ve sonrası yalnız hazırlanmış plandır; aktivasyon veya uygulama anlamına gelmez.
